...
This document provides comprehensive information for integrating with the MES Dashboard backend API and WebSocket services.
...
interface RealtimeData {
  ...
  Data: {
    ...
    ATST: number;  // Auto Start (0=off, 1=on)
